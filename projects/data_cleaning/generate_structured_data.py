...
def save_diagnosis_info(data, data_mapping, table_id, table_dict, uid_dict, output):  # noqa
    ...
    # entry_icd = data[table_source]['icd9code']
    # with open(ICD9_CSV_FILE, 'r', newline='') as csvfile:
    #     csvreader = csv.reader(csvfile, delimiter=',', quotechar='|')
    #     icd9_list = [row for row in csvreader]
    # with open(ICD10_CSV_FILE, 'r', newline='') as csvfile:
    #     csvreader = csv.reader(csvfile, delimiter=',', quotechar='|')
    #     icd10_list = [row for row in csvreader]
